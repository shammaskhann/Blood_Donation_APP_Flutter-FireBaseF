...
import 'package:project_jp/view/LogoutScreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: WillPopScope(
          onWillPop: () async {
            return HomeViewModel().onBackPressed(context);
          },
          child: StreamBuilder(
              stream: homeViewModel.getAllUsers(),
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: ((context) => DonorDetailScreen(
                                    ...
                                    phoneNumber: allUser[index]['Phone Number'],
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(allUser[index]['Phone Number']),
                                  Text(formattedDate),
                                ],
                              ),
                            ),
